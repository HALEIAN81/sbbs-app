...
const Author = () => {
  return (
    <div className="author">
      <h3 className="pageTitle">Meet the Author - Hale Verde</h3>
      <p>
        "I believe, life itself is the greatest mystery - but to add our own unique experiences 
        and creative endeavors is to uncover that mystery every day" - Hale Verde. 
