        ...
        >
          ...
          <div className="card-text">
            ...
            <p className="card-content">
              Introducing Scotland Backyard - The Knights Array - Volume I of a
              new children's mystery series. As the stories of Scotland Backyard
              unfold, we hope you will join our young brave investigators as
              they unlock the mysteries of their small town, save lives, play
              hockey and experience both joy and terror. What waits inside this
              deep labyrinth of tales will shake the foundation of their world
              forever.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="card-text">
            ...
            <p className="card-content">
              ...
              struggle. From the shadows emerge new and ruthless foes, each with
              their own designs on the prize. Can Shaw navigate this treacherous
              web of adversaries, safeguarding the amulet while protecting Jiro,
              Melissa, and the entire town caught in the crossfire? The fate of
